    ...
    <div className="relative w-full h-full  select-none">
      ...
      >
        <div className="relative w-full max-w-sm h-96 lg:h-[450px]">
          {/* Previous Image */}
          <div
            className={`absolute -left-8 top-1/2 w-60 h-full transition-all ease-out ${isDragging ? "duration-0" : "duration-600"
              }`}
            style={{
              transform: `translateY(-50%) translateX(${-15 + dragOffset * 0.2
                }px) scale(0.8)`,
              opacity: 0.6,
              zIndex: 1,
            }}
          ...
          {/* Current Image */}
          <div
            className={`absolute left-1/2 top-1/2 w-[22rem] h-full transition-all shadow-md ease-out ${isDragging ? "duration-0" : "duration-600"
              }`}
            style={{
          ...
          {/* Next Image */}
          <div
            className={`absolute -right-8 top-1/2 w-64 h-full transition-all ease-out ${isDragging ? "duration-0" : "duration-600"
              }`}
            style={{
              transform: `translateY(-50%) translateX(${15 + dragOffset * 0.2
                }px) scale(0.8)`,
...
const ProductOptions = ({
  ...
  // Filter available sizes based on the product's inventory details
  ...
  return (
    <div className="max-w-md mx-auto space-y-6 bg-white p-6 ">
      ...
      <div className="space-y-2 grid grid-cols-3 gap-4">
        ...
        <select
          className={`w-full col-span-2 border border-gray-300 px-3 py-2 text-xs flex items-center justify-between hover:bg-gray-50 transition-colors text-left ${selectedOptions.ringSize === "" ? "text-red-500" : "text-gray-700"
            }`}
