...
const Reviews = ({ isProductReview = false, productId = null }) => {
  ...
  const reviews = [
    ...
    { type: 'review', platform: 'Google', name: 'SARAH JOHNSON',  rating: 5, timeAgo: '2 days ago',   review: 'Absolutely stunning work! The team at Ardor created the perfect engagement ring. Professional service from start to finish.', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b632?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80' },
